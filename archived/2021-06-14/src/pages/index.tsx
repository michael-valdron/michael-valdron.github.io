                        ...
                        <div className="uk-card-body">
                            ...
                            <div className="uk-visible-toggle" tabIndex={-1} uk-slideshow="autoplay: true; autoplay-interval: 5000; max-height: 25;">
                                <ul className="uk-slideshow-items">
                                    <li><p className="uk-text-center">Software Engineer</p></li>
                                    <li><p className="uk-text-center">Optimization Specialist</p></li>
                                    <li><p className="uk-text-center">Data Engineer</p></li>
                                    <li><p className="uk-text-center">Full Stack Developer</p></li>
                                </ul>
                            </div>
                        </div>
                    </div>
