...
var G__24056 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24056;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24057 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24057,ch);
...
if(("\\" === ch__$1)){
var ch_24058__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24058__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24058__$2);
} else {
}

var G__24059 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24059;
continue;
}
}
...
var vec__24067 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24067,(0),null);
var start_column = cljs.core.nth.call(null,vec__24067,(1),null);
...
var G__24070 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24070;
continue;
}
}
...
var _STAR_read_delim_STAR_24071 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24071;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24072 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24072,(0),null);
var start_column = cljs.core.nth.call(null,vec__24072,(1),null);
...
var vec__24075 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24075,(0),null);
var end_column = cljs.core.nth.call(null,vec__24075,(1),null);
...
var vec__24078 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24078,(0),null);
var start_column = cljs.core.nth.call(null,vec__24078,(1),null);
...
var vec__24081 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24081,(0),null);
var end_column = cljs.core.nth.call(null,vec__24081,(1),null);
...
var vec__24084 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24084,(0),null);
var start_column = cljs.core.nth.call(null,vec__24084,(1),null);
...
var sb = (function (){var G__24090 = (new goog.string.StringBuffer());
G__24090.append(initch);
...
var G__24092 = (function (){var G__24091 = sb;
G__24091.append(ch);

return G__24091;
})();
var G__24093 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24092;
ch = G__24093;
continue;
}
...
switch (G__24096) {
case "\\":
var G__24100 = (function (){var G__24097 = sb;
G__24097.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24097;
})();
var G__24101 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24100;
ch = G__24101;
continue;
...
break;
default:
var G__24102 = (function (){var G__24098 = sb;
G__24098.append(ch);

return G__24098;
})();
var G__24103 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24102;
ch = G__24103;
continue;
...
var vec__24104 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24104,(0),null);
var end_column = cljs.core.nth.call(null,vec__24104,(1),null);
...
var vec__24107 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24107,(0),null);
var column = cljs.core.nth.call(null,vec__24107,(1),null);
...
var vec__24112 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24112,(0),null);
var column = cljs.core.nth.call(null,vec__24112,(1),null);
...
var vec__24117 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24117,(0),null);
var column = cljs.core.nth.call(null,vec__24117,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24122 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24122,(0),null);
var start_column = cljs.core.nth.call(null,vec__24122,(1),null);
...
var vec__24125 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24125,(0),null);
var end_column = cljs.core.nth.call(null,vec__24125,(1),null);
...
var G__24128 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24128,true,null,opts,pending_forms);
...
var G__24129 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24129)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24129)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24129)){
...
var _STAR_suppress_read_STAR_24130 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24130;
}});
...
var G__24131 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24131,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24131,rdr,first_line);
...
var G__24135 = matched;
var G__24136 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24135;
finished = G__24136;
continue;
} else {
...
var _STAR_suppress_read_STAR_24137 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24137;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24138 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24139 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24139,"(");
...
var G__24140 = (i + (1));
var G__24141 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24138;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24142 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24142);
...
var G__24143 = cljs.core.next.call(null,s__$1);
var G__24144 = ret;
s__$1 = G__24143;
r = G__24144;
continue;
...
var G__24145 = cljs.core.next.call(null,s);
var G__24146 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24145;
key_vals = G__24146;
continue;
} else {
...
var gensym_env24150 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24150;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24151 = token;
var G__24151__$1 = (((G__24151 == null))?null:cljs.core.subs.call(null,G__24151,(1)));
var G__24151__$2 = (((G__24151__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24151__$1));
var G__24151__$3 = (((G__24151__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24151__$2));
var G__24151__$4 = (((G__24151__$3 == null))?null:cljs.core.symbol.call(null,G__24151__$3));
if((G__24151__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24151__$4);
}
})():(function (){var G__24152 = token;
var G__24152__$1 = (((G__24152 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24152));
if((G__24152__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24152__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24163,reader){
...
var opts = map__24164__$1;
var eof = cljs.core.get.call(null,map__24164__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24170){
...
//# sourceMappingURL=reader.js.map?rel=1527748563779
