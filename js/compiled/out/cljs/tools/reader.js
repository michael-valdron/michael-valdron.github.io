...
var G__27830 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27830;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27831 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27831,ch);
...
if(("\\" === ch__$1)){
var ch_27832__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27832__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27832__$2);
} else {
}

var G__27833 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27833;
continue;
}
}
...
var vec__27841 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27841,(0),null);
var start_column = cljs.core.nth.call(null,vec__27841,(1),null);
...
var G__27844 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27844;
continue;
}
}
...
var _STAR_read_delim_STAR_27845 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_27845;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27846 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27846,(0),null);
var start_column = cljs.core.nth.call(null,vec__27846,(1),null);
...
var vec__27849 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27849,(0),null);
var end_column = cljs.core.nth.call(null,vec__27849,(1),null);
...
var vec__27852 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27852,(0),null);
var start_column = cljs.core.nth.call(null,vec__27852,(1),null);
...
var vec__27855 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27855,(0),null);
var end_column = cljs.core.nth.call(null,vec__27855,(1),null);
...
var vec__27858 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27858,(0),null);
var start_column = cljs.core.nth.call(null,vec__27858,(1),null);
...
var vec__27861 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27861,(0),null);
var end_column = cljs.core.nth.call(null,vec__27861,(1),null);
...
var sb = (function (){var G__27864 = (new goog.string.StringBuffer());
G__27864.append(initch);
...
var G__27866 = (function (){var G__27865 = sb;
G__27865.append(ch);

return G__27865;
})();
var G__27867 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27866;
ch = G__27867;
continue;
}
...
switch (G__27870) {
case "\\":
var G__27874 = (function (){var G__27871 = sb;
G__27871.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27871;
})();
var G__27875 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27874;
ch = G__27875;
continue;
...
break;
default:
var G__27876 = (function (){var G__27872 = sb;
G__27872.append(ch);

return G__27872;
})();
var G__27877 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27876;
ch = G__27877;
continue;
...
var vec__27878 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27878,(0),null);
var end_column = cljs.core.nth.call(null,vec__27878,(1),null);
...
var vec__27881 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27881,(0),null);
var column = cljs.core.nth.call(null,vec__27881,(1),null);
...
var vec__27886 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27886,(0),null);
var column = cljs.core.nth.call(null,vec__27886,(1),null);
...
var vec__27891 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__27896 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27896,(0),null);
var start_column = cljs.core.nth.call(null,vec__27896,(1),null);
...
var vec__27899 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27899,(0),null);
var end_column = cljs.core.nth.call(null,vec__27899,(1),null);
...
var G__27902 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27902,true,null,opts,pending_forms);
...
var G__27903 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27903)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27903)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27903)){
...
var _STAR_suppress_read_STAR_27904 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27904;
}});
...
var G__27905 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27905,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27905,rdr,first_line);
...
var G__27909 = matched;
var G__27910 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27909;
finished = G__27910;
continue;
} else {
...
var _STAR_suppress_read_STAR_27911 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27911;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env27912 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27913 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27913,"(");
...
var G__27914 = (i + (1));
var G__27915 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27912;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27916 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27916);
...
var G__27917 = cljs.core.next.call(null,s__$1);
var G__27918 = ret;
s__$1 = G__27917;
r = G__27918;
continue;
...
var G__27919 = cljs.core.next.call(null,s);
var G__27920 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27919;
key_vals = G__27920;
continue;
} else {
...
var gensym_env27924 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27924;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27925 = token;
var G__27925__$1 = (((G__27925 == null))?null:cljs.core.subs.call(null,G__27925,(1)));
var G__27925__$2 = (((G__27925__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27925__$1));
var G__27925__$3 = (((G__27925__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27925__$2));
var G__27925__$4 = (((G__27925__$3 == null))?null:cljs.core.symbol.call(null,G__27925__$3));
if((G__27925__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27925__$4);
}
})():(function (){var G__27926 = token;
var G__27926__$1 = (((G__27926 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27926));
if((G__27926__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27926__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e27933){if((e27933 instanceof Error)){
var e = e27933;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27937,reader){
var map__27938 = p__27937;
var map__27938__$1 = ((((!((map__27938 == null)))?(((((map__27938.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27938.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27938):map__27938);
var opts = map__27938__$1;
var eof = cljs.core.get.call(null,map__27938__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___27946 = arguments.length;
var i__4500__auto___27947 = (0);
while(true){
if((i__4500__auto___27947 < len__4499__auto___27946)){
args__4502__auto__.push((arguments[i__4500__auto___27947]));

var G__27948 = (i__4500__auto___27947 + (1));
i__4500__auto___27947 = G__27948;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27944){
var G__27945 = cljs.core.first.call(null,seq27944);
var seq27944__$1 = cljs.core.next.call(null,seq27944);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27945,seq27944__$1);
});


//# sourceMappingURL=reader.js.map?rel=1528121922516
