...
var o25318 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25318["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25319 = temp__5455__auto____$1;
return (o25319["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24430__auto__ = f;
return (o__24430__auto__["toString"]).call(o__24430__auto__);
} else {
return "";
}
}catch (e25320){var _ = e25320;
return "";
}});
...
try{var o__24430__auto___25322 = t;
(o__24430__auto___25322["cljs$lang$ctorPrWriter"]).call(o__24430__auto___25322,t,writer);
}catch (e25321){var __25323 = e25321;
}
...
var char_code = (function (){var o__24430__auto__ = (new String(char$));
return (o__24430__auto__["charCodeAt"]).call(o__24430__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24430__auto__ = String;
return (o__24430__auto__["fromCharCode"]).call(o__24430__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25324 = num_code;
switch (G__25324) {
case (1):
return (185);
...
var o__24430__auto__ = String;
return (o__24430__auto__["fromCharCode"]).call(o__24430__auto__,superscript_code);
});
/**
...
}catch (e25326){var _e__24437__auto__ = e25326;
return false;
}})())){
...
var vec__25327 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25327,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o25330 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25330["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25331 = temp__5455__auto____$1;
return (o25331["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25334){
var vec__25335 = p__25334;
var ns_detector = cljs.core.nth.call(null,vec__25335,(0),null);
...
var G__25341 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25342 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25341;
remaining_tokens = G__25342;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25332){
var G__25333 = cljs.core.first.call(null,seq25332);
var seq25332__$1 = cljs.core.next.call(null,seq25332);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25333,seq25332__$1);
});
...
var vec__25346 = cljs.core.split_with.call(null,(function (p1__25345_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25345_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25346,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25346,(1),null);
...
var vec__25349 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25349,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25349,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25352 = cljs.core.rest.call(null,remaining_tokens);
var G__25353 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25352;
name_tokens = G__25353;
continue;
} else {
...
var vec__25356 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25356,(0),null);
var arity = cljs.core.nth.call(null,vec__25356,(1),null);
var vec__25359 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25359,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25359,(1),null);
var vec__25362 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25362,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25362,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25362,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25362,(3),null);
...
var vec__25368 = result;
var munged_ns = cljs.core.nth.call(null,vec__25368,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25368,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25368,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25368,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25368,(4),null);
var arity = cljs.core.nth.call(null,vec__25368,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__25372 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__25372,(0),null);
var args = cljs.core.nth.call(null,vec__25372,(1),null);
var vec__25375 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25375,(0),null);
var name = cljs.core.nth.call(null,vec__25375,(1),null);
...
var G__25378 = (arity + (1));
var G__25379 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25380){
var vec__25381 = p__25380;
var arity = cljs.core.nth.call(null,vec__25381,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25381,(1),null);
...
return cljs.core.get.call(null,arities,p1__25384_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25385_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___25392 = arguments.length;
var i__4500__auto___25393 = (0);
while(true){
if((i__4500__auto___25393 < len__4499__auto___25392)){
args__4502__auto__.push((arguments[i__4500__auto___25393]));

var G__25394 = (i__4500__auto___25393 + (1));
i__4500__auto___25393 = G__25394;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25388){
var vec__25389 = p__25388;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25389,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25386){
var G__25387 = cljs.core.first.call(null,seq25386);
var seq25386__$1 = cljs.core.next.call(null,seq25386);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25387,seq25386__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25397__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25397__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25397__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25397__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25398 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25398,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25398,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25398,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25398,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25398,(4),null);
var arity = cljs.core.nth.call(null,vec__25398,(5),null);
...
var o__24430__auto__ = f;
return (o__24430__auto__["getBasis"]).call(o__24430__auto__);
});
/**
...
}catch (e25402){var _e__24437__auto__ = e25402;
...
var G__25403 = (obj[cljs.core.first.call(null,path)]);
var G__25404 = cljs.core.rest.call(null,path);
obj = G__25403;
path = G__25404;
continue;
} else {
...
return (function (accum,p__25405){
var vec__25406 = p__25405;
var bit = cljs.core.nth.call(null,vec__25406,(0),null);
var protocol = cljs.core.nth.call(null,vec__25406,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25409){
var vec__25410 = p__25409;
var ns = cljs.core.nth.call(null,vec__25410,(0),null);
var name = cljs.core.nth.call(null,vec__25410,(1),null);
var selector = cljs.core.nth.call(null,vec__25410,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25415,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25415,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25415,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25413_SHARP_){
return (obj[cljs.core.first.call(null,p1__25413_SHARP_)]);
});})(name,sorted_matches,vec__25415,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1527748565075
