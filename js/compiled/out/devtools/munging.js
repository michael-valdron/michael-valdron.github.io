...
var o25836 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25836["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25837 = temp__5455__auto____$1;
return (o25837["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24948__auto__ = f;
return (o__24948__auto__["toString"]).call(o__24948__auto__);
} else {
return "";
}
}catch (e25838){var _ = e25838;
return "";
}});
...
try{var o__24948__auto___25840 = t;
(o__24948__auto___25840["cljs$lang$ctorPrWriter"]).call(o__24948__auto___25840,t,writer);
}catch (e25839){var __25841 = e25839;
}
...
var char_code = (function (){var o__24948__auto__ = (new String(char$));
return (o__24948__auto__["charCodeAt"]).call(o__24948__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24948__auto__ = String;
return (o__24948__auto__["fromCharCode"]).call(o__24948__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25842 = num_code;
switch (G__25842) {
case (1):
return (185);
...
var o__24948__auto__ = String;
return (o__24948__auto__["fromCharCode"]).call(o__24948__auto__,superscript_code);
});
/**
...
}catch (e25844){var _e__24955__auto__ = e25844;
return false;
}})())){
...
var vec__25845 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25845,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o25848 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25848["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25849 = temp__5455__auto____$1;
return (o25849["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25852){
var vec__25853 = p__25852;
var ns_detector = cljs.core.nth.call(null,vec__25853,(0),null);
...
var G__25859 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25860 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25859;
remaining_tokens = G__25860;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25850){
...
var vec__25864 = cljs.core.split_with.call(null,(function (p1__25863_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25863_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25864,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25864,(1),null);
...
var vec__25867 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25867,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25867,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25870 = cljs.core.rest.call(null,remaining_tokens);
var G__25871 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25870;
name_tokens = G__25871;
continue;
} else {
...
var vec__25874 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25874,(0),null);
var arity = cljs.core.nth.call(null,vec__25874,(1),null);
var vec__25877 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25877,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25877,(1),null);
var vec__25880 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25880,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25880,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25880,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25880,(3),null);
...
var vec__25886 = result;
var munged_ns = cljs.core.nth.call(null,vec__25886,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25886,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25886,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25886,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25886,(4),null);
var arity = cljs.core.nth.call(null,vec__25886,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__25890 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__25890,(0),null);
var args = cljs.core.nth.call(null,vec__25890,(1),null);
var vec__25893 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25893,(0),null);
var name = cljs.core.nth.call(null,vec__25893,(1),null);
...
var G__25896 = (arity + (1));
var G__25897 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25898){
var vec__25899 = p__25898;
var arity = cljs.core.nth.call(null,vec__25899,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25899,(1),null);
...
return cljs.core.get.call(null,arities,p1__25902_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25903_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___25910 = arguments.length;
var i__4500__auto___25911 = (0);
while(true){
if((i__4500__auto___25911 < len__4499__auto___25910)){
args__4502__auto__.push((arguments[i__4500__auto___25911]));

var G__25912 = (i__4500__auto___25911 + (1));
i__4500__auto___25911 = G__25912;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25906){
var vec__25907 = p__25906;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25907,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25904){
var G__25905 = cljs.core.first.call(null,seq25904);
var seq25904__$1 = cljs.core.next.call(null,seq25904);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25905,seq25904__$1);
});
...
var map__25915 = options;
var map__25915__$1 = ((((!((map__25915 == null)))?(((((map__25915.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25915.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25915):map__25915);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25915__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25915__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25915__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25915__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25916 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25916,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25916,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25916,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25916,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25916,(4),null);
var arity = cljs.core.nth.call(null,vec__25916,(5),null);
...
var o__24948__auto__ = f;
return (o__24948__auto__["getBasis"]).call(o__24948__auto__);
});
/**
...
}catch (e25920){var _e__24955__auto__ = e25920;
...
var G__25921 = (obj[cljs.core.first.call(null,path)]);
var G__25922 = cljs.core.rest.call(null,path);
obj = G__25921;
path = G__25922;
continue;
} else {
...
return (function (accum,p__25923){
var vec__25924 = p__25923;
var bit = cljs.core.nth.call(null,vec__25924,(0),null);
var protocol = cljs.core.nth.call(null,vec__25924,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25927){
var vec__25928 = p__25927;
var ns = cljs.core.nth.call(null,vec__25928,(0),null);
var name = cljs.core.nth.call(null,vec__25928,(1),null);
var selector = cljs.core.nth.call(null,vec__25928,(2),null);
...
return (function (p__25932){
var vec__25933 = p__25932;
var munged_name = cljs.core.nth.call(null,vec__25933,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25933,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25933,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25931_SHARP_){
return (obj[cljs.core.first.call(null,p1__25931_SHARP_)]);
});})(name,sorted_matches,vec__25933,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1527842016310
