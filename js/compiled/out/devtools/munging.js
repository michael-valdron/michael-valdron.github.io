...
var o29442 = temp__5455__auto__;
var temp__5455__auto____$1 = (o29442["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29443 = temp__5455__auto____$1;
return (o29443["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28374__auto__ = f;
return (o__28374__auto__["toString"]).call(o__28374__auto__);
} else {
return "";
}
}catch (e29444){var _ = e29444;
return "";
}});
...
try{var o__28374__auto___29446 = t;
(o__28374__auto___29446["cljs$lang$ctorPrWriter"]).call(o__28374__auto___29446,t,writer);
}catch (e29445){var __29447 = e29445;
}
...
var char_code = (function (){var o__28374__auto__ = (new String(char$));
return (o__28374__auto__["charCodeAt"]).call(o__28374__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28374__auto__ = String;
return (o__28374__auto__["fromCharCode"]).call(o__28374__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29448 = num_code;
switch (G__29448) {
case (1):
return (185);
...
var o__28374__auto__ = String;
return (o__28374__auto__["fromCharCode"]).call(o__28374__auto__,superscript_code);
});
/**
...
}catch (e29450){var _e__28381__auto__ = e29450;
return false;
}})())){
...
var vec__29451 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__29451,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o29454 = temp__5455__auto__;
var temp__5455__auto____$1 = (o29454["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29455 = temp__5455__auto____$1;
return (o29455["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___29462 = arguments.length;
var i__4500__auto___29463 = (0);
while(true){
if((i__4500__auto___29463 < len__4499__auto___29462)){
args__4502__auto__.push((arguments[i__4500__auto___29463]));

var G__29464 = (i__4500__auto___29463 + (1));
i__4500__auto___29463 = G__29464;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29458){
var vec__29459 = p__29458;
var ns_detector = cljs.core.nth.call(null,vec__29459,(0),null);
...
var G__29465 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__29466 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__29465;
remaining_tokens = G__29466;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29456){
var G__29457 = cljs.core.first.call(null,seq29456);
var seq29456__$1 = cljs.core.next.call(null,seq29456);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29457,seq29456__$1);
});
...
var vec__29470 = cljs.core.split_with.call(null,(function (p1__29469_SHARP_){
return cljs.core.not_EQ_.call(null,p1__29469_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__29470,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__29470,(1),null);
...
var vec__29473 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__29473,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__29473,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__29476 = cljs.core.rest.call(null,remaining_tokens);
var G__29477 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__29476;
name_tokens = G__29477;
continue;
} else {
...
var vec__29480 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__29480,(0),null);
var arity = cljs.core.nth.call(null,vec__29480,(1),null);
var vec__29483 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__29483,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__29483,(1),null);
var vec__29486 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__29486,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__29486,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__29486,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__29486,(3),null);
...
var vec__29492 = result;
var munged_ns = cljs.core.nth.call(null,vec__29492,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__29492,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__29492,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__29492,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__29492,(4),null);
var arity = cljs.core.nth.call(null,vec__29492,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__29496 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__29496,(0),null);
var args = cljs.core.nth.call(null,vec__29496,(1),null);
var vec__29499 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__29499,(0),null);
var name = cljs.core.nth.call(null,vec__29499,(1),null);
...
var G__29502 = (arity + (1));
var G__29503 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29504){
var vec__29505 = p__29504;
var arity = cljs.core.nth.call(null,vec__29505,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29505,(1),null);
...
return cljs.core.get.call(null,arities,p1__29508_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29509_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___29516 = arguments.length;
var i__4500__auto___29517 = (0);
while(true){
if((i__4500__auto___29517 < len__4499__auto___29516)){
args__4502__auto__.push((arguments[i__4500__auto___29517]));

var G__29518 = (i__4500__auto___29517 + (1));
i__4500__auto___29517 = G__29518;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29512){
var vec__29513 = p__29512;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29513,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29510){
var G__29511 = cljs.core.first.call(null,seq29510);
var seq29510__$1 = cljs.core.next.call(null,seq29510);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29511,seq29510__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__29521__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29521__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29521__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29521__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29522 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29522,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29522,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29522,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29522,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29522,(4),null);
var arity = cljs.core.nth.call(null,vec__29522,(5),null);
...
var o__28374__auto__ = f;
return (o__28374__auto__["getBasis"]).call(o__28374__auto__);
});
/**
...
}catch (e29526){var _e__28381__auto__ = e29526;
...
var G__29527 = (obj[cljs.core.first.call(null,path)]);
var G__29528 = cljs.core.rest.call(null,path);
obj = G__29527;
path = G__29528;
continue;
} else {
...
return (function (accum,p__29529){
var vec__29530 = p__29529;
var bit = cljs.core.nth.call(null,vec__29530,(0),null);
var protocol = cljs.core.nth.call(null,vec__29530,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29533){
var vec__29534 = p__29533;
var ns = cljs.core.nth.call(null,vec__29534,(0),null);
var name = cljs.core.nth.call(null,vec__29534,(1),null);
var selector = cljs.core.nth.call(null,vec__29534,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__29539,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29539,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29539,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29537_SHARP_){
return (obj[cljs.core.first.call(null,p1__29537_SHARP_)]);
});})(name,sorted_matches,vec__29539,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1528121924923
