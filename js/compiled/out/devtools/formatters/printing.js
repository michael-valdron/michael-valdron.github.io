...
var len__4499__auto___29616 = arguments.length;
var i__4500__auto___29617 = (0);
while(true){
if((i__4500__auto___29617 < len__4499__auto___29616)){
args__4502__auto__.push((arguments[i__4500__auto___29617]));

var G__29618 = (i__4500__auto___29617 + (1));
i__4500__auto___29617 = G__29618;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29613){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29614,G__29615,seq29613__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29619_SHARP_){
return !((cljs.core.meta.call(null,p1__29619_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__29620__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29624){var _e__28381__auto__ = e29624;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e29626){var _e__28381__auto__ = e29626;
return false;
}}
})())){
...
var _STAR_current_state_STAR_29628 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__29629 = opts;
...
var markup_db = cljs.core.get.call(null,map__29629__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_29628;
}});
...
;
var temp__5455__auto___29633 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___29633)){
var managed_print_level_29634 = temp__5455__auto___29633;
var _STAR_print_level_STAR_29632_29635 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_29634;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_29632_29635,managed_print_level_29634,temp__5455__auto___29633,writer,opts,job_fn){
return (function (p1__29631_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__29631_SHARP_,null);
});})(_STAR_print_level_STAR_29632_29635,managed_print_level_29634,temp__5455__auto___29633,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_29632_29635;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1528121925302
