...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25446){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25452_SHARP_){
return !((cljs.core.meta.call(null,p1__25452_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__25453__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25457){var _e__24437__auto__ = e25457;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e25459){var _e__24437__auto__ = e25459;
return false;
}}
})())){
...
var _STAR_current_state_STAR_25461 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__25462 = opts;
var map__25462__$1 = ((((!((map__25462 == null)))?(((((map__25462.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25462.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25462):map__25462);
var markup_db = cljs.core.get.call(null,map__25462__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_25461;
}});
...
;
var temp__5455__auto___25466 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___25466)){
var managed_print_level_25467 = temp__5455__auto___25466;
var _STAR_print_level_STAR_25465_25468 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_25467;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_25465_25468,managed_print_level_25467,temp__5455__auto___25466,writer,opts,job_fn){
return (function (p1__25464_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25464_SHARP_,null);
});})(_STAR_print_level_STAR_25465_25468,managed_print_level_25467,temp__5455__auto___25466,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_25465_25468;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1527748565293
