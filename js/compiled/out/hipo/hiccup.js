...
var or__3922__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__21941 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__21941;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__3911__auto__ = id;
...
if(cljs.core.truth_((function (){var or__3922__auto__ = id;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){
return cljs.core._write.call(null,writer__4162__auto__,"hipo.hiccup/Sentinel");
});
...
var G__21943 = (function (){var f = cljs.core.first.call(null,s);
...
var G__21944 = cljs.core.rest.call(null,s);
v = G__21943;
s = G__21944;
continue;
} else {
...
var G__21945 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__21946 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__21945;
v__$1 = G__21946;
continue;
}
...
//# sourceMappingURL=hiccup.js.map?rel=1528121910554
