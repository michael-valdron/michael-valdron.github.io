...
return (new CustomEvent(event_name,(function (){var obj24375 = {"detail":data};
return obj24375;
})()));
} else {
...
var f = (function (){var pred__24382 = cljs.core._EQ_;
var expr__24383 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24382.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24383))){
return ((function (pred__24382,expr__24383){
return (function (p1__24376_SHARP_){
return console.warn(p1__24376_SHARP_);
});
;})(pred__24382,expr__24383))
} else {
if(cljs.core.truth_(pred__24382.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24383))){
return ((function (pred__24382,expr__24383){
return (function (p1__24377_SHARP_){
return console.debug(p1__24377_SHARP_);
});
;})(pred__24382,expr__24383))
} else {
if(cljs.core.truth_(pred__24382.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24383))){
return ((function (pred__24382,expr__24383){
return (function (p1__24378_SHARP_){
return console.error(p1__24378_SHARP_);
});
;})(pred__24382,expr__24383))
} else {
return ((function (pred__24382,expr__24383){
return (function (p1__24379_SHARP_){
return console.log(p1__24379_SHARP_);
});
;})(pred__24382,expr__24383))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24386){
...
var eval_fn = cljs.core.get.call(null,map__24387__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__24389_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__24391,(0),null);
...
}catch (e24396){if((e24396 instanceof Error)){
var e = e24396;
return not_found;
} else {
throw e24396;
...
//# sourceMappingURL=utils.js.map?rel=1527748564217
