...
var G__24221 = o;
(G__24221[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__24222__delegate = function (args){
...
while (G__24223__i < G__24223__a.length) {G__24223__a[G__24223__i] = arguments[G__24223__i + 0]; ++G__24223__i;}
  args = new cljs.core.IndexedSeq(G__24223__a,0,null);
} 
return G__24222__delegate.call(this,args);};
G__24222.cljs$lang$maxFixedArity = 0;
G__24222.cljs$lang$applyTo = (function (arglist__24224){
var args = cljs.core.seq(arglist__24224);
return G__24222__delegate(args);
});
...
var G__24225 = o;
(G__24225[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__24226__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__24227__i < G__24227__a.length) {G__24227__a[G__24227__i] = arguments[G__24227__i + 0]; ++G__24227__i;}
  args = new cljs.core.IndexedSeq(G__24227__a,0,null);
} 
return G__24226__delegate.call(this,args);};
G__24226.cljs$lang$maxFixedArity = 0;
G__24226.cljs$lang$applyTo = (function (arglist__24228){
var args = cljs.core.seq(arglist__24228);
return G__24226__delegate(args);
});
...
var G__24230 = props;
var G__24230__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__24230,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24230);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__24230__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__24231){
var map__24232 = p__24231;
var map__24232__$1 = ((((!((map__24232 == null)))?(((((map__24232.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24232.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24232):map__24232);
var props = map__24232__$1;
var class$ = cljs.core.get.call(null,map__24232__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__24232,map__24232__$1,props,class$){
return (function (c){
...
});})(map__24232,map__24232__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__24234){
var map__24235 = p__24234;
var map__24235__$1 = ((((!((map__24235 == null)))?(((((map__24235.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24235.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24235):map__24235);
var on_write = cljs.core.get.call(null,map__24235__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__24235,map__24235__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__24235,map__24235__$1,on_write))
);
} else {
...
var G__24238 = jsprops;
(G__24238["defaultValue"] = value);

(G__24238["onChange"] = ((function (G__24238,v,value,on_change){
return (function (p1__24237_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24237_SHARP_);
});})(G__24238,v,value,on_change))
);
...
var vec__24241 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24241,(0),null);
var id = cljs.core.nth.call(null,vec__24241,(1),null);
var class$ = cljs.core.nth.call(null,vec__24241,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___24245 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___24245 == null)){
} else {
var key_24246 = temp__5461__auto___24245;
(jsprops["key"] = key_24246);
}
...
var temp__5461__auto___24247 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___24247 == null)){
} else {
var key_24248 = temp__5461__auto___24247;
reagent.impl.template.oset.call(null,jsprops,"key",key_24248);
}
...
var G__24249 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__24249["name"] = c);
...
var len__4499__auto___24254 = arguments.length;
var i__4500__auto___24255 = (0);
while(true){
if((i__4500__auto___24255 < len__4499__auto___24254)){
args__4502__auto__.push((arguments[i__4500__auto___24255]));

var G__24256 = (i__4500__auto___24255 + (1));
i__4500__auto___24255 = G__24256;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24252){
var G__24253 = cljs.core.first.call(null,seq24252);
var seq24252__$1 = cljs.core.next.call(null,seq24252);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24253,seq24252__$1);
});
...
break;
default:
var G__24259 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__24259;
continue;
...
var n__4376__auto___24261 = a.length;
var i_24262 = (0);
while(true){
if((i_24262 < n__4376__auto___24261)){
(a[i_24262] = reagent.impl.template.as_element.call(null,(a[i_24262])));

var G__24263 = (i_24262 + (1));
i_24262 = G__24263;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___24264 = a.length;
var i_24265 = (0);
while(true){
if((i_24265 < n__4376__auto___24264)){
var val_24266 = (a[i_24265]);
if(((cljs.core.vector_QMARK_.call(null,val_24266)) && ((reagent.impl.template.key_from_vec.call(null,val_24266) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24265] = reagent.impl.template.as_element.call(null,val_24266));

var G__24267 = (i_24265 + (1));
i_24265 = G__24267;
continue;
} else {
}
...
var ctx = ({});
var vec__24268 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24268,(0),null);
var derefed = cljs.core.nth.call(null,vec__24268,(1),null);
...
var G__24271 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24271) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__24271){
...
//# sourceMappingURL=template.js.map?rel=1528121915094
